...
top_board_snap_lip_overlap_z = 3.5;
...
top_board_snap_lead_z = 1.5;

assert(abs(top_board_inward_fang_h_z
           - top_board_snap_lip_overlap_z
           - top_board_snap_lead_z) < eps,
       "top board pocket lost its staggered insertion lead");
...
// DRY-ONLY: paired, deliberately shallow +Y retention ridges for the clock
// string guide. Each is a narrow vertical bead along the full Z edge of its
// existing X-end recess, matching the marked edge in the fit review.
clock_bar_detent_projection_x = 0.20;
clock_bar_detent_ramp_y = 0.60;
clock_bar_detent_h_z = clock_bar_trap_h_z;
clock_bar_detent_y0 = clock_bar_trap_y1 - clock_bar_detent_ramp_y;
clock_bar_detent_z0 = clock_bar_trap_z0;
