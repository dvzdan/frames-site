...
if (!assembly.includes("Already have your parts and images?") || !assembly.includes('href="#setup-manual"') || !assembly.includes("Start assembly") || !assembly.includes('href="/build/#plans"') || !assembly.includes("Print the parts") || !assembly.includes("Prepare the images")) errors.push("Assembly entry choices are incomplete");
